...
export default Ember.Controller.extend({
  items: Ember.computed(function(){
    ...
    let i1 = {itemName: "Frontside Misty", price: 5.0, gunType:"AK-47", imageUrl: "1",
    condition:"Field-Tested", rarity: "Classified", isStattrack: true};
    items.push(i1);

    let i2 = {itemName: "Mudder", price: 1.23, gunType:"Desert Eagle", imageUrl: "2",
    condition:"Well-Worm", rarity: "Industrial Grade"};
    items.push(i2);

    let i3 = {itemName: "Forest DDPAT", price: 0.77, gunType:"MP7", imageUrl: "3",
    condition:"Battle-Scarred", rarity: "Consumer Grade"};
    items.push(i3);

    let i4 = {itemName: "Howl", price: 500.0, gunType:"M4A4", imageUrl: "4",
    condition:"Factory New", rarity: "Contraband", isStattrack: true};
    items.push(i4);

    let i5 = {itemName: "Origami", price: 4.0, gunType:"Sawed-Off", imageUrl: "5",
    condition:"Minimal Wear", rarity: "Mil-Spec"};
    items.push(i5);

    let i6 = {itemName: "Blue Steel", price: 9.51, gunType:"Bayonet", imageUrl: "6",
  ...
  actions: {
    generateItem(item) {
      ...
      // window.App.currentUser.get('items').pushObject(newItem);
    }
  }
});
